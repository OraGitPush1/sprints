...
- Provisioned a vm which will be used in Task1 
...
## Lab Task 1: Confirm the Remote Desktop Environment
...
## Lab Task 2: Observe Automatic Shard Failover
...
## Lab Task 3: Startup the previously shutdown shard
